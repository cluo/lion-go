...
type EntryMessage struct {
	Encoding *string `thrift:"encoding,1" json:"encoding,omitempty"`
...
type Entry struct {
	...
	Level         *Level            `thrift:"level,2" json:"level,omitempty"`
	TimeUnixNanos *int64            `thrift:"time_unix_nanos,3" json:"time_unix_nanos,omitempty"`
	Context       []*EntryMessage   `thrift:"context,4" json:"context,omitempty"`
	Fields        map[string]string `thrift:"fields,5" json:"fields,omitempty"`
	Event         *EntryMessage     `thrift:"event,6" json:"event,omitempty"`
	Message       *string           `thrift:"message,7" json:"message,omitempty"`
	WriterOutput  []byte            `thrift:"writer_output,8" json:"writer_output,omitempty"`
}
